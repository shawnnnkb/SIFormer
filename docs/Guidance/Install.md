# Conda SIFormer Installation

**a. Create a conda virtual environment and activate it.**
```shell
conda create -n SIFormer python=3.7 -y
...
# ImportError: cannot import name 'PythonShell' from 'pyface.api' 
# (/home/name/.conda/envs/mayavi_vis/lib/python3.10/site-packages/pyface/api.py),
# then modify 'from .python_shell import PythonShell'
```