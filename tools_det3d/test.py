...
def parse_args():
    ...
    parser.add_argument('--config', default='./projects/SIFormer/configs/vod-SIFormer_det3d_2x4_24e.py', help='test config file path')
    parser.add_argument('--checkpoint', default='./projects/SIFormer/checkpoints/best_VoD_LiDAR.pth', help='checkpoint file')
