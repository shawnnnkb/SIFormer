...
class SUNRGBDData(object):
    ...
    def get_image(self, idx):
        img_filename = osp.join(self.image_dir, f'{idx:05d}.jpg')
    ...
    def get_depth(self, idx):
        depth_filename = osp.join(self.depth_dir, f'{idx:05d}.mat')
        depth = sio.loadmat(depth_filename)['instance']
        return depth

    def get_calibration(self, idx):
        calib_filepath = osp.join(self.calib_dir, f'{idx:05d}.txt')
    ...
    def get_label_objects(self, idx):
        label_filename = osp.join(self.label_dir, f'{idx:05d}.txt')
    ...
    def get_infos(self, num_workers=4, has_label=True, sample_id_list=None):
        ...
        def process_single_scene(sample_idx):
            ...
            pc_upright_depth_subsampled.tofile(
                osp.join(self.root_dir, 'points', f'{sample_idx:05d}.bin'))

            info['pts_path'] = osp.join('points', f'{sample_idx:05d}.bin')
            img_path = osp.join('image', f'{sample_idx:05d}.jpg')
            image_info = {
